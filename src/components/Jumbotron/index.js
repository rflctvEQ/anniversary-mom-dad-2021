    ...
    return (
        <div className='d-flex justify-content-center'>
            <div className='jumbotron custom-jumbo'>
                ...
                <p className='line line-2'>Your relationship really has served as an example to me in my relationship with Lulu. The good <em>and</em> the not so good, the highs and the lows, but most importantly the <strong>unending</strong> love you share informs me everyday in my relationship with Lulu.</p>
